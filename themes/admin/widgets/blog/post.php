...
<section class="dash_content_app">
    <?php if (!$post): ?>
        ...
        <div class="dash_content_app_box">
            <form class="app_form" action="<?= url("/admin/blog/post"); ?>" method="post">
                ...
                <label class="label">
                    <span class="legend">Posição:</span>
    ...
    <?php else: ?>
        <header class="dash_content_app_header">
            ...
            <a class="icon-link btn btn-green" href="<?= url("/{$post->uri}"); ?>" target="_blank" title="">Ver no
                site</a>
        </header>
        ...
        <div class="dash_content_app_box">
            <form class="app_form" action="<?= url("/admin/blog/post/{$post->id}"); ?>" method="post">
                ...
                <label class="label">
                    ...
                    <select name="position">
                        <option value="">Selecione uma posição</option>
                        <option value="highlight" <?= ($post->position == 'highlight' ? 'selected' : ''); ?>>Destaque</option>
                        <option value="relevant" <?= ($post->position == 'relevant' ? 'selected' : ''); ?>>Relevante</option>
                    </select>
                </label>
