...
<div class="dash">
    <aside class="dash_sidebar">
        ...
        <ul class="dash_sidebar_nav">
            ...
            echo $nav("tachometer", "dash", "Dashboard");
            echo $nav("pencil-square-o", "blog/home", "Blog");
//            echo $nav("comments-o", "faq/home", "FAQs");
            echo $nav("user", "users/home", "Usuários");
            echo "<li class=\"dash_sidebar_nav_li\"><a class=\"icon-link-external\" href=\"" . url() . " \" target=\"_blank\">Ver site</a></li>";
        ...
        <div class="dash_userbar">
            <div class="dash_userbar_box">
                <div class="dash_content_box">
                    <h1 class="icon-cog transition"><a href="<?= url("/admin/dash"); ?>">h<b>control</b></a></h1>
